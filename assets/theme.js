(function ($) {
  ...
  class AccordionInstance {
    constructor(container) {
      ...
      this.titleClassLink = '.cc-accordion-item__title a';
    ...
    handleClick(e) {
      ...
      var toggleLink = e.target.closest(this.titleClassLink);
      if (!toggle || toggleLink) return;
  ...
  theme.buildRecentProduct = function (item, showHover, showVendor) {
    ...
    $('<div class="product-block__title">').html(item.title).appendTo($item);
